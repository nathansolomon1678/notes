...
If $W$ doesn't repeat any vertices, this is clearly true. Otherwise, we can split it into to shorter walks, one of which uses $e$ an odd number of times. If $|W|=1$, this statement is true, so by induction, it's always true.
